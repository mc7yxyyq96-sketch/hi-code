...
export function createHiCodeApi(rawApi = window.hicode, { onError = null } = {}) {
  ...
  return {
    ...
    terminalCreate: (payload) => call("terminalCreate", [payload], { ok: false }),
    terminalWrite: (payload) => call("terminalWrite", [payload], { ok: false }),
    terminalKill: (payload) => call("terminalKill", [payload], { ok: false }),
    terminalList: () => call("terminalList", [], { ok: false, sessions: [] }),
    onTerminalReady: (cb) => listen("onTerminalReady", cb),
    onTerminalData: (cb) => listen("onTerminalData", cb),
    onTerminalExit: (cb) => listen("onTerminalExit", cb),
    listAutomations: () => call("listAutomations", [], { ok: true, items: [] }),
    getAutomation: (id) => call("getAutomation", [id], { ok: false }),
    createAutomation: (payload) => call("createAutomation", [payload], { ok: false }),
    updateAutomation: (payload) => call("updateAutomation", [payload], { ok: false }),
    removeAutomation: (id) => call("removeAutomation", [id], { ok: false }),
    setAutomationEnabled: (payload) => call("setAutomationEnabled", [payload], { ok: false }),
    dueAutomations: (payload) => call("dueAutomations", [payload], { ok: true, items: [] }),
    markAutomationRun: (payload) => call("markAutomationRun", [payload], { ok: false }),
    browserOpen: (payload) => call("browserOpen", [payload], { ok: false }),
    browserClose: () => call("browserClose", [], { ok: false }),
    browserBounds: (payload) => call("browserBounds", [payload], { ok: false }),
    browserNavigate: (payload) => call("browserNavigate", [payload], { ok: false }),
    browserBack: () => call("browserBack", [], { ok: false }),
    browserForward: () => call("browserForward", [], { ok: false }),
    browserReload: () => call("browserReload", [], { ok: false }),
    browserState: () => call("browserState", [], { ok: false }),
    onBrowserMeta: (cb) => listen("onBrowserMeta", cb),
    scanCodemap: (payload) => call("scanCodemap", [payload], { ok: false, files: [], symbols: [] }),
    listMemory: (payload) => call("listMemory", [payload], { ok: true, memory: { notes: [] } }),
    addMemory: (payload) => call("addMemory", [payload], { ok: false }),
    removeMemory: (payload) => call("removeMemory", [payload], { ok: false }),
    pinMemory: (payload) => call("pinMemory", [payload], { ok: false }),
    rollbackRunChanges: () => call("rollbackRunChanges", [], { ok: false, count: 0 }),
    gatewayStart: (payload) => call("gatewayStart", [payload], { ok: false }),
    gatewayStop: () => call("gatewayStop", [], { ok: false }),
    gatewayStatus: () => call("gatewayStatus", [], { ok: true, running: false }),
    gatewayConnectRemote: (payload) => call("gatewayConnectRemote", [payload], { ok: false }),
