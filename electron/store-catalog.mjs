// Built-in store catalog (China-friendly defaults).
// Exported to store/catalog.json via scripts/export-store-catalog.mjs — run `npm run store:export` after editing.
export const BUILTIN_STORE_CATALOG = [
  {
